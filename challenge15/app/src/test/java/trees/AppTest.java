...
public class AppTest {
    ...
    public void fizzBuzzTests() {
        ...
        KNode root = new KNode("21");
        KNode node1 = new KNode("10");
        KNode node2 = new KNode("20");
        KNode node3 = new KNode("65");
        KNode node4 = new KNode("30");
        KNode node5 = new KNode("90");
        KNode node6 = new KNode("12");
        ...
        assertEquals("Fizz Buzz Buzz Buzz FizzBuzz FizzBuzz Fizz ",ktree.fizzBuzz(root));
